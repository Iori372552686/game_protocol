...
var file_dbsvr_proto_rawDesc = string([]byte{
	...
	0x75, 0x6c, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var (
	...
	file_dbsvr_proto_rawDescData []byte
)

func file_dbsvr_proto_rawDescGZIP() []byte {
	file_dbsvr_proto_rawDescOnce.Do(func() {
		file_dbsvr_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dbsvr_proto_rawDesc), len(file_dbsvr_proto_rawDesc)))
	})
	return file_dbsvr_proto_rawDescData
}

var file_dbsvr_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_dbsvr_proto_goTypes = []any{
...
func file_dbsvr_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dbsvr_proto_rawDesc), len(file_dbsvr_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   33,
			NumExtensions: 6,
			NumServices:   0,
