...
var file_game_enum_proto_rawDesc = string([]byte{
	...
	0x4f, 0x4d, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x10, 0x03, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74,
...
var (
	...
	file_game_enum_proto_rawDescData []byte
)

func file_game_enum_proto_rawDescGZIP() []byte {
	file_game_enum_proto_rawDescOnce.Do(func() {
		file_game_enum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_game_enum_proto_rawDesc), len(file_game_enum_proto_rawDesc)))
	})
	return file_game_enum_proto_rawDescData
}

var file_game_enum_proto_enumTypes = make([]protoimpl.EnumInfo, 16)
var file_game_enum_proto_goTypes = []any{
...
func file_game_enum_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_game_enum_proto_rawDesc), len(file_game_enum_proto_rawDesc)),
			NumEnums:      16,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
